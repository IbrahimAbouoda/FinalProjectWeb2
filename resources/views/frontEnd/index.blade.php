                ...
                <div class="row pb-4">
                    <div class="col-md-5">
                        <div class="fh5co_hover_news_img">
                            ...
                            <div class="fh5co_news_img"><img src="{{asset('storage/'.$post->image)}}" alt="post image"/></div>
                            <div></div>
                        </div>
                    </div>
                    <div class="col-md-7 animate-box">
                        <a href="single.html" class="fh5co_magna py-2"> {{$post->title}} </a> <a href="#" class="fh5co_mini_time py-3"> {{$post->auther}} -
                        {{$post->created_at}} </a>
                        <div class="fh5co_consectetur"> {{$post->Content}}</div>
                    </div>
                </div>
